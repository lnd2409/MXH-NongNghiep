                    ...
                    <div class="col-9">
                        ...
                        <section class="invoice p-3">
                            ...
                            <div class="col-xs-12">
                                ...
                                Tên nông sản: {{$nuoitrong->spnt_ten}}
                                <br>
                            ...
                            <div class="col-sm-4 invoice-col">
                                <p>Loại nông sản: {{$nuoitrong->lns_ten}}</p>
                                <p>Giá khuyễn mãi: {{$nuoitrong->spnt_thongtin}}</p>
                                <p>Sản lượng dự kiến: {{$nuoitrong->nt_sanluongdutinh}}</p>
                                <p>Sản lượng thực tế: {{$nuoitrong->nt_sanluongthucte}}</p>
                                <p>Tháng bắt đầu mùa vụ: {{$nuoitrong->mv_thangbatdau}}</p>
                                <p>Tháng kết thúc mùa vụ: {{$nuoitrong->mv_thangketthuc}}</p>
                            
                                <p><b>Mô tả: {{$nuoitrong->spnt_thongtin}}</b></p>
                                <p>Số lượng nông sản: {{$quymo->qm_soluongnongsan}}</p>

                                <form action="{{ route('don-vi-tinh', ['idspnt'=> $nuoitrong->spnt_id]) }}" method="get">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 table-responsive"  style="margin-left: 10px">
                                    <p>
                                        <a href="{{ route('giao-dien-them-hinh-anh', ['id'=> $nuoitrong->spnt_id ]) }}" class="btn btn-primary">Thêm ảnh</a>
                                    </p>
                                </div>
                            </div>
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap" id="category_table">
                                        ...
                                        <tbody>
                                            ...
                                            $stt=1;
                                            @endphp
                                            @foreach ($anhnongsan as $item => $value)
                                                <tr>
                                                    <td>{{$stt++}}</td>
                                                    
                                                    <td>
                                                        <img src="{{ asset('hinhanh/nongdan') }}/{{ $value->ha_ten }}" alt="Ảnh sản phẩn" width="200" height="200">
                                                    </td>
                                                    <td>
                                                        
                                                        <a href="{{ route('xoa-hinh-anh', ['idHA'=> $value->ha_id, 'idSP' => $nuoitrong->spnt_id ]) }}" class="btn btn-danger mt-2">Xóa</a>
