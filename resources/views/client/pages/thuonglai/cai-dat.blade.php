                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-acc" role="tabpanel"
                            ...
                            <div class="acc-setting">
                                ...
                                <form action="{{ route('caidat.submit') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="notbar">
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                              <tr>
                                                ...
                                                <td><input type="text" class="form-control" value="{{$data->tl_hoten}}" name="tl_hoten"  style="font-weight:bold"></td>
                                              </tr>
                                              <tr>
                                                <th class="tl_infor">Số điện thoại:</th>
                                                <td><input type="text" class="form-control" value="{{$data->tl_sdt}}" name="tl_sdt" ></td>
                                              </tr>
                                              <tr>
                                                <th class="tl_infor">Địa chỉ:</th>
                                                <td><input type="text" class="form-control" value="{{$data->tl_diachi}}" name="tl_diachi"   ></td>
                                              </tr>
                                             <tr>
                        ...
                        <div class="tab-pane fade" id="nav-password" role="tabpanel" aria-labelledby="nav-password-tab">
                            <div class="acc-setting">
                                ...
                                <div class="changePassword">
                                        <form method="POST" id="form-data" enctype="multipart/form-data" action="{{ route('caidat.submit.matkhau') }}">
                                            @csrf
                                        <div class="cp-field">
                                            <h5>Mật khẩu cũ</h5>
                                            <div class="cpp-fiel ">
                                                <input type="password" class="form-control " name="tl_password" id="tl_password">
                                        ...
                                        <div class="cp-field">
                                            <h5>Mật khẩu mới</h5>
                                            <div class="cpp-fiel">
                                                <input type="password" name="tl_password1" class="form-control " id="tl_password1">
                                                <i class="fa fa-lock"></i>
                                        ...
                                        <div class="cp-field">
                                            ...
                                            <div class="cpp-fiel">
                                                <input type="password" name="tl_password2" class="form-control " id="tl_password2">
                                                <i class="fa fa-lock"></i>
                                                <small id="" class="form-text text-muted"></small>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        //lấy mật khẩu cũ
        $('#tl_password').keyup(function (e) { 

            e.preventDefault();

            var tl_password = $("input[name='tl_password']").val();
            // console.log(tl_password);

            var tl_password1 = $("input[name='tl_password1']").val();
            // console.log(tl_password1);

            var tl_password2 = $("input[name='tl_password2']").val();
            ...
            $.ajax({
                type: "POST",
                url: "{{route('caidat.submit.kiemtra')}}",
                data: {_token:_token,tl_password:tl_password,tl_password1:tl_password1,tl_password2:tl_password2},
                success: function (data) {
                    if(data.success)
                    {
                        console.log(data.success);
                        $("#tl_password").removeClass("is-invalid");
                        $("#tl_password").addClass("is-valid");
                        $("#tl_password1").removeAttr('disabled'); 
                        $("#tl_password2").removeAttr('disabled'); 
                    }
                    else{
                        console.log(data.error);
                        $("#tl_password").addClass("is-invalid");
                        $("#tl_password1").attr('disabled','disabled');
                        $("#tl_password2").attr('disabled','disabled');
       ...
       $('#tl_password2').keyup(function (e) {
            ...
            if(tl_password1 !='' && tl_password2 !='' && tl_password1 == tl_password2){
                ...
                $("#tl_password1").removeClass("is-invalid")
                $("#tl_password2").removeClass("is-invalid")
                $("#tl_password1").addClass("is-valid")
                $("#tl_password2").addClass("is-valid")
                $("#save").removeAttr('disabled');
            }
            else{
                $("#tl_password1").addClass("is-invalid");
                $("#tl_password2").addClass("is-invalid");
