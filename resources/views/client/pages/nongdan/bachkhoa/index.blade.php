        ...
        <section class="forum-sec">
            <div class="container">
                <div class="forum-links">
                    <ul>
                        <li><a href="{{ route('trang-chu-nong-dan') }}" title="">Bài viết quan tâm</a></li>
                        <li><a href="#" title="">Bài viết trong nhóm</a></li>
                        <li  class="active"><a href="{{ route('bachkhoa-nd') }}" title="">Bách khoa nông nghiệp</a></li>
                    </ul>
                </div>
                <!--forum-links end-->
                                ...
                                <div class="usr-question">
                                    ...
                                    <div class="usr_quest">
                                        <h3 style="margin-bottom: 0px;"><a
                                                href="{{route('bachkhoa-bv',$item->bk_id)}}">{{$item->bk_tieude}}</a></h3>
