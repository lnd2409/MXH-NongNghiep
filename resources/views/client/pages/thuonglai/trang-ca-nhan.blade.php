...
<section class="cover-sec">
    <img src="{{asset('hinhanh/nguoidung/thuonglai/'.$data->tl_background)}}" style="height: 400px" alt="">
                    ...
                    <div class="col-lg-3">
                        <div class="main-left-sidebar">
                            <div class="user_profile">
                                ...
                                <img src="{{asset('hinhanh/nguoidung/thuonglai/'.$data->tl_hinhanh)}}" style="width:70%" alt="">
                                ...
                                <div class="user_pro_status">
                                    <ul class="flw-hr">
                                        <br>
                                        <li><a href="{{ route('nhat-ky-nong-ho',[ 'id' => \Auth::guard('thuonglai')->user()->tl_id ]) }}" title="" class="flww"><i class="la la-book"></i> Nhật ký nông hô</a></li>
                                    ...
                                    @foreach ($baiviet as $item)
                                        ...
                                        <div class="post-bar">
                                            <div class="post_topbar">
                                                <div class="usy-dt">
                                                    <img src="{{asset('hinhanh/nguoidung/thuonglai/'.$data->tl_hinhanh)}}" height="50px" width="50px" alt="">
                                                    <div class="usy-name">
                                                        <h3>{{ $data->tl_hoten }}</h3>
