                        ...
                        <div class="main-left-sidebar no-margin">
                            ...
                            <div class="tags-sec full-width">
                                ...
                                <div class="cp-sec">
                                    ...
                                    <p><img src="{{asset('client/images/cp.png')}}" alt="">Copyright 2018</p>
                                </div>
                            </div>
                            <!--tags-sec end-->
                        </div>
                                ...
                                <div class="post-bar">
                                    <div class="post_topbar">
                                        <div class="usy-dt">
                                            ...
                                            <div class="usy-name">
                                                <h3>John Doe</h3>
                                                <span><img src="{{asset('client/images/clock.png')}}" alt="">3 min
                                                    ago</span>
                                            </div>
                                        </div>
                                        <div class="ed-opts">
                                    ...
                                    <div class="epi-sec">
                                        <ul class="descp">
                                            <li><img src="{{asset('client/images/icon8.png')}}" alt=""><span>Epic
                                                    Coder</span></li>
                                            <li><img src="{{asset('client/images/icon9.png')}}"
                                    ...
                                    <div class="job-status-bar">
                                        <ul class="like-com">
                                            <li>
                                                ...
                                                <img src="{{asset('client/images/liked-img.png')}}" alt="">
                                                <span>25</span>
                                            </li>
                                            <li><a href="#" title="" class="com"><img
                                                        src="{{asset('client/images/com.png')}}" alt="">
                                                    Comment 15</a></li>
                                        </ul>
                                        ...
                                        <div class="user-profy">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#" title="" class="envlp"><img
                                                            src="{{asset('client/images/envelop.png')}}" alt=""></a>
                                                </li>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="comment-list">
                                                        ...
                                                        <div class="comment">
                                                            <h3>John Doe</h3>
                                                            <span><img src="{{asset('client/images/clock.png')}}"
                                                                    alt=""> 3 min
                                                                ago</span>
                                                        ...
                                                        <li>
                                                            <div class="comment-list">
                                                                ...
                                                                <div class="comment">
                                                                    <h3>John Doe</h3>
                                                                    <span><img
                                                                            src="{{asset('client/images/clock.png')}}"
                                                                            alt=""> 3 min
                                                                        ago</span>
                                                                    <p>Hi John </p>
                                                                    <a href="#" title=""><i
                    ...
                    <div class="col-lg-3 pd-right-none no-pd">
                        <div class="right-sidebar">
                            <div class="widget widget-about">
                                <img src="{{asset('client/images/wd-logo.png')}}" alt="">
